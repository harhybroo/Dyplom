...
import { CreateOfficeService } from "features/CreatePlacement/model/services/CreateOfficeService";
    ...
    return (
        <div className={styles.placement}>
            <div className={styles.placement_left}>
                ...
                <div className={styles.block}>
                    <p className={styles.block_title}>Количество помещений *</p>
                    <span className={styles.block_desc}>
                        Укажите количество помещений
                    </span>
                    <Dropdown
                ...
                <div className={`${styles.block} ${styles.square}`}>
                    <p className={styles.block_title}>Площадь офиса (м2) *</p>
                    <span className={styles.block_desc}>
            ...
            <div className={styles.placement_right}>
                ...
                <div className={`${styles.block} ${styles.num}`}>
                    ...
                    <span className={styles.block_desc}>
                        Укажите на каком этаже находится офис
                    </span>
                    <Input
                        theme={InputTheme.FORM}
